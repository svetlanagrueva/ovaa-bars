...
export const PRODUCTS: Product[] = [
  {
    ...
    shortDescription: 'Кутия от 12 протеинови бара с натурален шоколад. Наситен какаов вкус с пълноценен яйчен протеин.',
    fullDescription: `Насладете се на интензивния, наситен вкус на висококачествен натурален шоколад, докато зареждате тялото си с пълноценен протеин. Всеки бар Egg Origin Натурален Шоколад съдържа 20g яйчен протеин - пълноценен животински протеин с всички есенциални аминокиселини, от които тялото ви се нуждае.
...
Тази кутия съдържа 12 индивидуално опаковани бара - вашият месечен запас от чист, функционален протеин.`,
    ...
    badge: 'Бестселър',
    boxContents: '12 x бара Натурален Шоколад',
    barsCount: 12,
    nutritionHighlights: ['20g Протеин', 'Без добавена захар', 'Натурални съставки'],
    nutritionFacts: {
      calories: 195,
      protein: 20,
      carbs: 15,
    ...
    benefits: [
      ...
      'Без суроватка и излишни съставки',
...
Тази кутия съдържа 12 индивидуално опаковани бара - идеални за вкъщи, в офиса или в спортната чанта.`,
    ...
    benefits: [
      'Пълноценен протеин с всички есенциални аминокиселини',
      'С истински лиофилизирани малини',
  ...
  },
  {
    ...
    slug: 'mix-box',
    name: 'Микс',
    shortDescription: 'Кутия от 12 смесени бара - 6 Натурален Шоколад + 6 Бял Шоколад с Малини. Най-доброто от двата вкуса.',
    fullDescription: `Не можете да решите между наситения натурален шоколад и нежния бял шоколад с малини? Вземете най-доброто от двата вкуса с нашата Микс Кутия. Този разнообразен пакет включва 6 бара Натурален Шоколад и 6 бара Бял Шоколад с Малини - перфектен за да откриете любимия си вкус или да внесете разнообразие.

И двата вкуса са създадени с 20g висококачествен яйчен протеин на бар, доставяйки пълноценно хранене без суроватка, без подуване и без излишни съставки. Независимо дали предпочитате интензивното удоволствие от натуралния шоколад или плодовата сладост на белия шоколад с малини, тази кутия ви предлага и двете.
...
Перфектното въведение в Egg Origin или чудесен начин да споделите с приятели и семейство.`,
    ...
    badge: 'Популярен',
    boxContents: '6 x Натурален Шоколад + 6 x Бял Шоколад с Малини',
    barsCount: 12,
    nutritionHighlights: ['20g Протеин', 'Без добавена захар', 'Натурални съставки'],
    nutritionFacts: {
      calories: 192,
